...
void loop(){
  ...
  LT = (ldr1State + ldr2State) / 2;
  TR = (ldr2State + ldr3State) / 2;
  RB = (ldr3State + ldr4State) / 2;
  BL = (ldr3State + ldr1State) / 2;
  ...
  else if(val1 > 100 && ldr1State > ldr3State){
    pos1 = pos1 + 1;
  ...
  else if(val2 > 100 && ldr2State > ldr4State){
    pos2 = pos2 + 1;
